...
generate_and_write_rsa_keypair(path_to_root_key, bits=2048, password=passw )
...
generate_and_write_rsa_keypair(path_to_root_key2)

# Import an existing public key.
public_root_key = import_rsa_publickey_from_file(path_to_root_key_public)
...
private_root_key2 = import_rsa_privatekey_from_file(path_to_root_key2 , password=passw )
...
generate_and_write_rsa_keypair(path_to_target_key, password=passw )
#generate_and_write_rsa_keypair("path/to/release_key", password="password")
generate_and_write_rsa_keypair(path_to_timestamp_key, password=passw )

# Add the public keys of the remaining top-level roles.
repository.targets.add_key(import_rsa_publickey_from_file(path_to_target_key_public))
repository.release.add_key(import_rsa_publickey_from_file(path_to_timestamp_key_public ))
repository.timestamp.add_key(import_rsa_publickey_from_file(path_to_release_key_public ))
