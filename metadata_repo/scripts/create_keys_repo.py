...
generate_and_write_rsa_keypair("/var/www/root_key", bits=2048, password="password")
...
generate_and_write_rsa_keypair("/var/www/root_key2")

# Import an existing public key.
public_root_key = import_rsa_publickey_from_file("/var/www/root_key.pub")
...
repository = create_new_repository("/var/www/")
...
public_root_key2 = import_rsa_publickey_from_file("/var/www/root_key2.pub")
...
private_root_key2 = import_rsa_privatekey_from_file("/var/www/root_key2", password="password")
...
generate_and_write_rsa_keypair("/var/www/targets_key", password="password")
#generate_and_write_rsa_keypair("path/to/release_key", password="password")
generate_and_write_rsa_keypair("/var/www/timestamp_key", password="password")

# Add the public keys of the remaining top-level roles.
repository.targets.add_key(import_rsa_publickey_from_file("/var/www/targets_key.pub"))
repository.release.add_key(import_rsa_publickey_from_file("/var/www/timestamp_key.pub"))
repository.timestamp.add_key(import_rsa_publickey_from_file("/var/www/timestamp_key.pub"))
